...
{
  /// <summary>
  /// Formulario principal para el administrador.
  /// </summary>
  public partial class FormAdmin : Form
  {
    ...
    private void LoadData()
    {
      ...
      {
        // Cargar datos de usuarios y mapearlos a una lista anónima.
        ...
        // Ocultar la columna "Id" en el DataGridView de usuarios.
    ...
    // Eventos de botones y otros controles
    ...
    /// <summary>
    /// Evento al seleccionar una pestaña en el TabControl.
    /// </summary>
    private void tabControl1_Selecting(object sender, TabControlCancelEventArgs e)
    {
      // Lógica a implementar en caso de necesitar una acción al seleccionar una pestaña.
    }

    /// <summary>
    /// Evento al hacer clic en el botón para crear un nuevo usuario.
    /// Abre el formulario para crear usuarios y recarga los datos después de cerrar el formulario.
    /// </summary>
    ...
    /// <summary>
    /// Evento al hacer doble clic en una celda del DataGridView de usuarios.
    /// Abre el formulario para editar el usuario seleccionado y recarga los datos después de cerrar el formulario.
    /// </summary>
